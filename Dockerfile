FROM debian:bookworm-slim@sha256:60eac759739651111db372c07be67863818726f754804b8707c90979bda511df AS supercronicverify
...
RUN apt-get update \
    && apt-get install -y --no-install-recommends --no-install-suggests gettext-base jq procps xdg-user-dirs patch unzip \
    && apt-get autoremove -y --purge \
    && apt-get clean \
    && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
